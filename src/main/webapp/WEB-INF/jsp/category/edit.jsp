...
<div class="content-right">
    ...
    <div class="content-text">
        <div class="square-order">
            <s:form action="category_updateIfPresent" method="post">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr bgcolor="#FFFFFF">
                            ...
                            <td width="82%" colspan="3">
                                <s:textfield name="category.name" size="25"/>
                            </td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                            <td width="18%" height="30" align="center">供应商:</td>
                            <td width="82%" colspan="3">
                                <s:select name="supplierId" list="supplierList" listKey="id" listValue="name" cssStyle="width: 190px"></s:select>
                            </td>
                        </tr>
                        <tr bgcolor="#FFFFFF">
                            <td colspan="4">&nbsp;</td>
